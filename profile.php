...
<style>
body { background: linear-gradient(135deg,#c7b299,#d9cbb8,#bfa88c); font-family:"Poppins",sans-serif; min-height:100vh;}
.profile-box {background:#fdf8f3;padding:30px;border-radius:15px;border:2px solid #b08c6d;box-shadow:0 8px 20px rgba(50,30,10,0.2);}
.profile-title {text-align:center;color:#4a321c;font-weight:700;}
.label {font-weight:600;color:#4a321c;}
.input-custom {border-radius:10px;border:1px solid #c8a27e;padding:10px;}
.btn-save {background:#8b5e34;color:white;padding:10px 20px;border-radius:10px;}
.btn-save:hover { background:#734b2a; }
.btn-token {background:#4a7c59;color:white;padding:10px 20px;border-radius:10px;display:block;text-align:center;text-decoration:none;margin-top:10px;}
.btn-token:hover { background:#366644; }
</style>
</head>
<body>
