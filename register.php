...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($valid) {
        ...
        $stmt = $conn->prepare("INSERT INTO users (name, phone, email, password, email_verified_at, remember_token, created_at, updated_at, role_id) VALUES (?, ?, ?, ?, NOW(), NULL, NOW(), NOW(), 1)");
        ...
        <div class="container mt-5 pt-5">
            ...
            <div class="card shadow-lg">
                <div class="left-panel">
                    ...
                    <a href="login.php" class="btn btn-outline-light btn-login fw-bold">LOG IN</a>
                </div>
